...
const Header = async ({dictionary}:{dictionary: Dictionary}) => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-white z-10">
      ...
      <div className="py-5 md:py-[30px] container flex justify-between items-center">
        <div className="logo relative w-[106px] md:w-[192px] h-5 md:h-9">
          <Image src="/logos/clarifon.png" alt="Clarifon" fill className="object-contain" />
        </div>

        <div className="flex gap-4 md:gap-8">
          <div className="w-11 h-4 md:w-[88px] md:h-[32px]">
